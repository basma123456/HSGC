...
class UpdateAboutCompanyRequset extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'left_first_image' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg|min:120',
            'left_second_image' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg|min:120',
            'our_vision_image' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg|min:120',
...
//            'behind_hsgc_summary' => 'required|string',
    ...
    public function messages()
    {
        return [
            ...
            'left_first_image.nullable' => trans('validation.nullable')  ,
            ...
            'left_second_image.nullable' => trans('validation.nullable')  ,
            ...
            'our_vision_image.nullable' => trans('validation.nullable')  ,
...
//            'behind_hsgc_summary.required' => trans('validation.required')  ,
//            'behind_hsgc_summary.string' => trans('validation.string')  ,
