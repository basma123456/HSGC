...
//            ddd($request->all());
            ...
            if($request->at_front_page == 1){
                Landscape::query()->update(['at_front_page' => 0]);
            ...
            $landscape->at_front_page  = $request->at_front_page;
...
//            ddd($request->all());
            ...
            if(request()->hasFile('image') && request('image') != '') {
                $imagePath2 = public_path('/assets/images_front/projects_page/'.$landscape->image);
    ...
    public function destroy(Landscape $landscape)
    {
        try {
            ...
            if(File::exists(public_path('/assets/images_front/projects_page/'.$landscape->image))) {
                $this->deleteUploadedImage($landscape->image, '/assets/images_front/projects_page/');
            }
